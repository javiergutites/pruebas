/*
 * NAME = com.vectorsf.test_base.model.dao.TestBaseDAO.java;
 *
...
package com.vectorsf.test_base.model.dao;
...
public interface TestBaseDAO extends DAO<TestBase, Integer> {
